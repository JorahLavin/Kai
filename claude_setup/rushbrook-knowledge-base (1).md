...
- **Clover/First Data merchant account:** Was dormant; PCI compliance was an active concern. Resolved April 2026 — called Clover Security, rep walked through questionnaire. Key finding: business profile was incorrect; once corrected to reflect that Square/WooCommerce handles all payment processing, questionnaire dropped from ~225 questions to ~6. **PCI compliant through April 2027.**
